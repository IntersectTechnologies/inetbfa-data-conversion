...
from zipline.data2.loader import load_market_data
...
class TradingEnvironment(object):
    ...
    def __init__(
        ...
        self.benchmark_returns, treasury_curves = load(bm_symbol=self.bm_symbol, 
									source=source,
									authtoken=authtoken)
...
class SimulationParameters(object):
    ...
    def _update_internal(self):
        ...
        start_index = environment.get_index(self.first_open)
        end_index = environment.get_index(self.last_close)

        # take an inclusive slice of the environment's
        # trading_days.
        self.trading_days = environment.trading_days[start_index:end_index + 1]
