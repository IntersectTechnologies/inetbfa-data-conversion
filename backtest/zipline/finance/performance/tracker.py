...
class PerformanceTracker(object):
    ...
    def __init__(self, sim_params):
        ...
        if self.emission_rate == 'daily':
            ...
            self.cumulative_risk_metrics = risk.RiskMetricsCumulative(self.sim_params)
    ...
    def handle_minute_close(self, dt):
        ...
        self.intraday_risk_metrics.update(dt, minute_returns, self.all_benchmark_returns[dt])

        bench_since_open = self.intraday_risk_metrics.benchmark_cumulative_returns[dt]
    ...
    def handle_intraday_market_close(self, new_mkt_open, new_mkt_close):
        ...
        self.intraday_risk_metrics = risk.RiskMetricsCumulative(self.sim_params)
